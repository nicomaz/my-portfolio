...
export default function BrowserMenu({ setShowTabs, showTabs }: Props) {
  return (
    <div className="w-full h-[2.5rem] absolute bottom-0 rounded-b-lg bg-gray-300">
      ...
      <div
        className="h-6 w-9 border-black border-[2px] rounded text-center leading-5 absolute bottom-2.5 right-3"
        onClick={() => {
